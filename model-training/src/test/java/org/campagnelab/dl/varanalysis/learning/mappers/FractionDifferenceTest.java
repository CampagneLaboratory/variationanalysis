...
import org.campagnelab.dl.model.utils.mappers.FractionDifferences;
 ...
 */
public class FractionDifferenceTest {
    @Test
    public void mapFeatures() throws Exception {
    int index=0;

        for (String record : records) {
            FractionDifferences calculator = new FractionDifferences();

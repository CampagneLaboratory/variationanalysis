 ...
 */
public class PredictMutationsV9Trio extends AbstractPredictMutations {
    static private Logger LOG = LoggerFactory.getLogger(PredictMutationsV9Trio.class);

    final static String TIME = "fixed-rindex-1469817194827";
    ...
    public static void main(String[] args) throws Exception {
        ...
        PredictMutationsV9Trio predictor = new PredictMutationsV9Trio();
    ...
    public String featuresToString(BaseInformationRecords.BaseInformation pos) {
        ...
        String features = (pos.hasFrequencyOfMutation() ? pos.getFrequencyOfMutation() : "") + "\t"
                ...
                + Arrays.toString(s3Counts) + "\t"
                + Arrays.toString(s1Scores) + "\t"
                + Arrays.toString(s2Scores) + "\t"
                + Arrays.toString(s3Scores) + "\t"
                + Integer.toString(IntStream.of(s1Counts).sum() + IntStream.of(s2Counts).sum() + IntStream.of(s3Counts).sum());
        return features;
    }

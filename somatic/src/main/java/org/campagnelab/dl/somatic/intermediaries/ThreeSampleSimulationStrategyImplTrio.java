...
/**
 * Created by rct66
 * This strategy verifies that mendelian rules are followed.
 */
public class ThreeSampleSimulationStrategyImplTrio implements SimulationStrategy {
    private XorShift1024StarRandom randomGenerator;
    private double canonThreshold;

    public ThreeSampleSimulationStrategyImplTrio(long seed) {
        setSeed(seed);
    }

    public ThreeSampleSimulationStrategyImplTrio() {

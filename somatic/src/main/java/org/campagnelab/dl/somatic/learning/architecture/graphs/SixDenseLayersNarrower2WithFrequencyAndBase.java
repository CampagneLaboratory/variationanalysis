 ...
 * and frequency of the mutation (0 when no mutation).
 * <p>
 *
 * @author Fabien Campagne
 */
public class SixDenseLayersNarrower2WithFrequencyAndBase implements ComputationalGraphAssembler {
    ...
    public ComputationGraph createComputationalGraph(DomainDescriptor domainDescriptor) {
        ...
        int numOutputsIsMutated = domainDescriptor.getNumOutputs("isBaseMutated")[0];
        ...
        ComputationGraphConfiguration conf = graphConfiguration
                ...
                .addLayer("dense5", new DenseLayer.Builder().nIn((int) (numHiddenNodes * Math.pow(reduction, 3))).nOut((int) (numHiddenNodes * Math.pow(reduction, 4)))
                        ...
                        .activation("relu")
                        .build(), "dense4")
                .addLayer("isBaseMutated", new OutputLayer.Builder(domainDescriptor.getOutputLoss("isBaseMutated"))
                        .weightInit(WEIGHT_INIT)
    ...
    public String[] getOutputNames() {
        return new String[]{"isBaseMutated", "somaticFrequency"};
    }

...
import org.campagnelab.dl.varanalysis.mappers.MagnitudeFeatures2;
 ...
 */
public class MagnitudeFeatures2Test {
    @Test
    public void mapFeatures() throws Exception {
        MagnitudeFeatures2 magnitude = new MagnitudeFeatures2();

        assertEquals(20, magnitude.numberOfFeatures());

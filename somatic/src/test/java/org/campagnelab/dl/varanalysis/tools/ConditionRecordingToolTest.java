    ...
    public void tryTags() throws IOException {
        ...
        assertEquals("Model condition file does not match expected.",
                "Tag|Results|Specified_Arguments|Default_Arguments|Classname\n" +
                        "3UNZVP||--learning-rate 1.0 --model-conditions test-results/model-conditions/1.txt " +
                        "--random-seed 1478359791323 --training-sets [T] --validation-set V|" +
                        "--dropout-rate null --early-stopping-num-epochs 10 --error-enrichment false " +
                        "--experimental-condition not_specified --feature-mapper " +
                        "org.campagnelab.dl.varanalysis.mappers.FeatureMapperV19 --learning-rate 1.0 " +
                        "--max-epochs 2147483647 --mini-batch-size 32 " +
                        "--model-conditions test-results/model-conditions/1.txt --net-architecture ABC " +
                        "--num-errors-added 16 --num-training 2147483647 --num-validation 2147483647 " +
                        "--parameter-precision FP32 --previous-model-name bestAUC --previous-model-path null " +
                        "--random-seed 1478359791323 --regularization-rate null --training-sets [T] --validate-every 1 --validation-set V|\n",

...
import org.campagnelab.dl.varanalysis.mappers.FractionDifferences2;
 ...
 */
public class FractionDifferences2Test {
    ...
    private INDArray getFeatures(BaseInformationRecords.BaseInformation.Builder builderPlain) {
        FeatureMapper calculator = new FractionDifferences2();

...
import org.campagnelab.dl.varanalysis.mappers.trio.FractionDifferences4Trio;
 ...
 */
public class FractionDifferences4TrioTest {
    ...
    private INDArray getFeatures(BaseInformationRecords.BaseInformation.Builder builderPlain) {
        FeatureMapper calculator = new FractionDifferences4Trio(0);

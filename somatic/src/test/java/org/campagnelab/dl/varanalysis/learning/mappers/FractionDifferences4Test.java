...
import org.campagnelab.dl.varanalysis.mappers.FractionDifferences4;
 ...
 */
public class FractionDifferences4Test {
    ...
    private INDArray getFeatures(BaseInformationRecords.BaseInformation.Builder builderPlain) {
        FeatureMapper calculator = new FractionDifferences4();

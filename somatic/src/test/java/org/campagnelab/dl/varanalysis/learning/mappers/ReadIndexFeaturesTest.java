...
import org.campagnelab.dl.varanalysis.mappers.ReadIndexFeaturesFix;
 ...
 */
public class ReadIndexFeaturesTest {
    @Test
    public void mapFeatures() throws Exception {
        int index=0;

        for (String record : records) {
            ReadIndexFeaturesFix calculator = new ReadIndexFeaturesFix();

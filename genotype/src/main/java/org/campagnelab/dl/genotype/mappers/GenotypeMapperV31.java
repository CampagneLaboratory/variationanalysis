 ...
 * This mapper does not map matchesReference.
 */
public class GenotypeMapperV31 extends GenotypeMapperV11 {
    ...
    public GenotypeMapperV31() {
        this(0);
    }

    public GenotypeMapperV31(int sampleIndex) {
        super();

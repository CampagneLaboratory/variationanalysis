...
// */
//public abstract class GenotypeTrainer extends ConditionRecordingTool<GenotypeTrainingArguments> {
...
//        try {
//            featureMapper = configureFeatureMapper(args().featureMapperClassname, args().getTrainingSets());
...
//    protected LabelMapper labelMapper = new GenotypeLabelMapper(0);
...
//        labelMapper = new GenotypeLabelMapper(0);
...
//    }
//
//    protected void writeProperties(GenotypeTrainer trainer) throws IOException {
...
//
//
//    public static FeatureMapper configureFeatureMapper(String featureMapperClassname, String[] trainingSets) throws IOException {
//
//
//        try {
//            Class clazz = Class.forName(featureMapperClassname);

 ...
 * This m
 */
public class GenotypeMapperV3 extends NamingConcatFeatureMapper<BaseInformationRecords.BaseInformationOrBuilder> implements ConfigurableFeatureMapper {
    ...
    public void configure(Properties sbiProperties) {
        ...
        FeatureNameMapper[] matchesRefMappers = new FeatureNameMapper[10];
        int genotypeIndex = 0;
        for (int i = 0; i < 10; i++) {

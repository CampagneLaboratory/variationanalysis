...
/**
 * V19, but with IsIndelMappers and VariantTypeMappers
 */
public class GenotypeMapperV27 extends GenotypeMapperV11 {
    ...
    public void configure(Properties sbiProperties) {
        ...
        FeatureNameMapper[] variantTypeMappers = new FeatureNameMapper[MAX_GENOTYPES];
        ...
        for (int i = 0; i < MAX_GENOTYPES; i++) {
            ...
            variantTypeMappers[i] = new VariantTypeMapper(sampleIndex, i);
        ...
        delegate =
                new CountReorderingMapper(sampleIndex, new NamingConcatFeatureMapper<>(
                        ...
                        new NamingConcatFeatureMapper<BaseInformationRecords.BaseInformationOrBuilder>(variantTypeMappers)
                ));

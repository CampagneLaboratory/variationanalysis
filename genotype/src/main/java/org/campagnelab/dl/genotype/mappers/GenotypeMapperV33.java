 ...
 * Add count mapper with ceiling normalization.
 * Remove matchesReference mappers.
 */
public class GenotypeMapperV33 extends GenotypeMapperV11 {
    ...
    public GenotypeMapperV33() {
        this(0);
    }

    public GenotypeMapperV33(int sampleIndex) {
        super();
